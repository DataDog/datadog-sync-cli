...
class LogsPipelines(BaseResource):
    ...
    async def create_resource(self, _id: str, resource: Dict) -> Tuple[str, Dict]:
        ...
        self.config.storage.data[self.resource_type].destination[_id] = self.destination_integration_pipelines[
            resource["name"]
        ]
    ...
    async def update_resource(self, _id: str, resource: Dict) -> Tuple[str, Dict]:
        current_destination_resource = self.config.storage.data[self.resource_type].destination[_id]
    ...
    async def delete_resource(self, _id: str) -> None:
        if self.config.storage.data[self.resource_type].destination[_id]["is_read_only"]:
