...
class MetricTagConfigurations(BaseResource):
    ...
    def get_resources(self, client: CustomClient) -> List[Dict]:
        resp = client.get(
            self.resource_config.base_path, params={"filter[configured]": "true"}
        ).json()
    ...
    def pre_apply_hook(self, resources: Dict[str, Dict]) -> Optional[list]:
        self.destination_metric_tag_configurations = (
            self.get_destination_metric_tag_configuration()
        )
        return None
    ...
    def create_resource(self, _id: str, resource: Dict) -> None:
        if _id in self.destination_metric_tag_configurations:
            self.resource_config.destination_resources[
                _id
            ] = self.destination_metric_tag_configurations[_id]
        ...
        resp = destination_client.post(
            ...
            + f"/{self.resource_config.source_resources[_id]['id']}/tags",
            payload,
        ).json()
    ...
    def update_resource(self, _id: str, resource: Dict) -> None:
        ...
        resp = destination_client.patch(
            self.resource_config.base_path
            + f"/{self.resource_config.destination_resources[_id]['id']}/tags",
            payload,
        ).json()
