...
class IncidentsConfigNotificationsTemplates(BaseResource):
    resource_type = "incidents_config_notifications_templates"
    resource_config = ResourceConfig(
        base_path="/api/v2/incidents/config/notifications/templates",
        excluded_attributes=[
    ...
    # Additional IncidentsConfigNotificationsTemplates specific attributes
