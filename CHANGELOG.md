...
**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/4.20.0...4.20.1
...
### Fixed
* fix(downtime_schedules): reconcile destination conflicts by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/656


**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/4.18.0...4.19.0
...
**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/3.1.0...3.1.4
...
**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/3.1.0...3.1.2
...
### Added
* First pass at skipping certs by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/416


**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/2.0.8...2.0.9
...
**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/2.0.5...2.0.6
...
### Changed
* Changed synthetics test resource by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/389
* Added hard retry limit by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/379
* Change the retry error condition by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/380
* Fixes for migrations of resources by @michael-richey in https://github.com/DataDog/datadog-sync-cli/pull/384
...
**Full Changelog**: https://github.com/DataDog/datadog-sync-cli/compare/1.1.1...1.2.0
